<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql="insert into `contact` (email,mobileno,productname,complaint) 
		values('$email','$mobileno','$productname','$complaint')";
...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <form method="post" name="contactform" onsubmit="return validateform()" class="p-4 shadow rounded bg-light">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="Mobile No" name="mobileno">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" placeholder="Complaint" name="complaint" rows="4"></textarea>
                </div>
	...
	<!-- <div class="container">
		<form method="post" name="contactform"
			...
			<textarea type="text" placeholder="Complaint" name="complaint"></textarea>
			<br><br>

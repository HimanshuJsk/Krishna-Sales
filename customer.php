...
<body>
    ...
    <div class="row flex-wrap">
      ...
      <div class="col-12 col-md-9 col-lg-9 px-3 py-2">
        <!--start sign-up form--> 
        <h1 class="text-decoration-underline mt-3 mb-4">Contact Us Form</h1>
                    ...
                    if($result){
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            <div class="operation-buttons">
                                <a href="updatecustomer.php?updateid=' . $id . '" class="btn btn-primary text-light" style="text-decoration:none;">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="deletecustomer.php?deleteid=' . $id . '" class="btn btn-danger text-light" style="text-decoration:none;">

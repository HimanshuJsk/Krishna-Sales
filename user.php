...
<body>
    ...
    <div class="row flex-wrap">
      ...
      <div class="col-12 col-md-9 col-lg-9 px-3 py-2">
        <!--start sign-up form--> 
        <h1 class="text-decoration-underline mt-3 mb-4">Sign-Up Form</h1>
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            <td>
                              <div class="operation-buttons">
                                <a href="updateuser.php?updateid=' . $id . '" class="btn btn-primary btn-sm">
                                  <i class="fas fa-edit"></i>
                                </a>
                                <a href="deleteuser.php?deleteid=' . $id . '" class="btn btn-danger btn-sm">
